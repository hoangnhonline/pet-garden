...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '31203';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = 'aec1cbdca6232bcb'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
